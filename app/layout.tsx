...
export const metadata: Metadata = {
  ...
  title: {
    default: "Deli Mwitu Restaurant | Authentic Kenyan Cuisine in Hurlingham, Nairobi",
    template: "%s | Deli Mwitu Restaurant",
  },
  description:
  ...
  keywords: [
    "Deli Mwitu Restaurant",
    "Restaurant Hurlingham",
    "Restaurant Nairobi",
    "Kenyan Restaurant Nairobi",
    "Kenyan Cuisine Nairobi",
    "African Restaurant Nairobi",
  ...
  other: {
    "application-name": "Deli Mwitu Restaurant",
    ...
    images: [
      {
        ...
        width: 756,
        height: 682,
        alt: "Deli Mwitu Restaurant - Premium Coffee in Nairobi",
      },
      {
        url: "/logo.svg",
        width: 90,
        height: 36,
        alt: "Deli Mwitu Restaurant Logo",
      },
    ],
  },
  twitter: {
