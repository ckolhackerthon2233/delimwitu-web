...
export default function MainsPage() {
  ...
  const filteredItems =
    activeFilter === "all"
      ? getItemsByCategory("mains")
      : getItemsByCategory("mains").filter(
  ...
  const getCategoryDescription = (cat: string) => {
    const descriptions: Record<string, string> = {
      all: "Heartier dishes to satisfy your appetite",
      beef: "Premium beef selections and steaks",
      chicken: "Succulent chicken dishes",
    ...
    <div className="min-h-screen bg-gradient-to-b from-cream via-white to-warm-white">
      ...
      <div className="pt-32 pb-20 px-6 bg-gradient-to-r from-dark-brown to-orange">
        <div className="text-center text-white">
          <h1 className="text-6xl md:text-7xl font-black mb-6">Main Courses</h1>
          <p className="text-xl md:text-2xl mb-4 text-white/90">
            Savor our exquisite main courses
          </p>
